...
if(isset($_GET['vkey'])){
    ...
    $result=$con->query("SELECT verfied,vkey FROM parent WHERE verified = 0 AND vkey='$vkey' LIMIT 1");
  
        $update = $con->query("UPDATE parent SET verified = 1 WHERE vkey='$vkey' LIMIT 1");
        if($update){
