...
if(isset($_POST['submit'])){
    ...
    $resultset=$con->query("SELECT * FROM parent WHERE username='$u' AND password='$p' LIMIT 1");
    ...
    $u1=str_replace("+","2",$u);
        ...
        header("location:parenthome.php?parent_account_&welcome=$u1");
       }
       else{
           $error="THIS ACCOUNT IS NOT YET VERIFIED.Email has been sent to $email ";
       }
    }
    else{
...
<h2 align="center">Parents Login</h2>
    ...
    <a class="float-right" href="changeps.php?val=1">Forgot password</a>
    </form>
    </div>
  </div>
  </div>
